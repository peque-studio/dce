...
# Modifications: added '# type: ignore' on lines 194 and 195, these two comments and newlines around them.
...
def run_clang_format_diff(args, file):
    ...
    outs = list(proc_stdout.readlines()) # type: ignore
    errs = list(proc_stderr.readlines()) # type: ignore
    proc.wait()
    if proc.returncode:
        raise DiffError(
